...
**오늘 한 일**
1. **기술5 CLI 블로그 초안 작성** (`docs/blog/초안/06-CLI출력-콘솔에서예쁘게.md`)
...
5. **섹션 번호 정리** (1~10번까지 재정렬)

**블로그 초안 구조 (10개 섹션)**
| 섹션 | 내용 |
|------|------|
| 1. 들어가며 | 비유, CLI 먼저 만든 이유 |
| 2. CLI란 무엇인가? | CLI vs GUI, Java CLI 구현 방법 |
| 3. Picocli 사용법 | 개념, 의존성, 기본 구조 |
| 4. 프로젝트에 적용하기 | 직접 파싱 → Picocli 적용 |
| 5. 박스 문자 | `├── └── │` 트리 구조 |
| 6. ANSI 색상 | 이스케이프 시퀀스, 레이어별 색상 |
| 7. Windows 인코딩 | CP949 vs UTF-8, 4가지 해결법 |
